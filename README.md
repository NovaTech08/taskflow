...
Cómo ejecutarlo:
Navegar a la carpeta del código fuente:Abrir una terminal y posicionarse en la carpeta donde está el archivo de proyecto:cd src/TaskFlow
Compilar y ejecutar:Ingresar el siguiente comando para que .NET inicie la aplicación:dotnet run Uso del Sistema:
